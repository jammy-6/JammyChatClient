...
#include "Global.h"
#include <QPainter>
RegisterWindow::RegisterWindow(QWidget *parent) : MoveableWidget(parent) {
	initUI();
	initConnect();
}
...
void RegisterWindow::initUI() {
	...
	QSpacerItem *rightPushSpacerItem1 = new QSpacerItem(
		registerConfirmPassword->label->sizeHint().width() - registerPassword->label->sizeHint().width(), 30, QSizePolicy::Policy::Fixed, QSizePolicy::Policy::Fixed);
	...
	QSpacerItem *rightPushSpacerItem2 = new QSpacerItem(
		registerValidateCodeLabel->sizeHint().width() - registerPassword->label->sizeHint().width(), 30, QSizePolicy::Policy::Fixed, QSizePolicy::Policy::Fixed);
