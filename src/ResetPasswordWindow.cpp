...
ResetPasswordWindow::ResetPasswordWindow(QWidget *parent) : MoveableWidget(parent) {
	initUI();
	initConnect();
}
...
void ResetPasswordWindow::initUI() {
	...
	QSpacerItem *rightPushSpacerItem1 = new QSpacerItem(
		resetPassword->label->sizeHint().width() - resetUser->label->sizeHint().width(), 30, QSizePolicy::Policy::Fixed, QSizePolicy::Policy::Fixed);
	...
	QSpacerItem *rightPushSpacerItem2 = new QSpacerItem(
		resetValidateCodeLabel->sizeHint().width() - resetUser->label->sizeHint().width(), 30, QSizePolicy::Policy::Fixed, QSizePolicy::Policy::Fixed);
